    ...
    IdentityUser user = new()
    {
        ...
        List<Produto> produtos = new()
        {
            ...
            new Produto(){
                ...
                Descricao = "Play Has No Limits™ Jogar Não Tem Limites PlayStation®5. Oconsole PS5™ oferece novas possibilidades de jogabilidade que você nunca imaginou. Reproduza jogos para PS5 e PS4 em Blu-ray Disc. Além disso, você também pode baixar  jogos ...",
                Preco = 3699.99M,
                Estoque = 6,
                CategoriaId = 2,
            ...
            new Produto(){
                ...
                Descricao = "Cadeira Gamer Fortt Lípsia Vermelha - CGF002-V Seja paratrabalhar, estudar ou para seu lazer, a cadeira tornou-se um item essencial para o dia a dia. Agora ela não só é mais um item de decoração da casa ou de uso esporádico" ,
                Preco = 221.11M,
                Estoque = 30,
                CategoriaId = 2,
            ...
            new Produto(){
                ...
                Descricao = "Notebook 2 Em 1 Positivo Duo C4128b-3 Intel Celeron DualCore Windows11 Home 11,6' - Cinza Escuro - Inclui Microsoft 365* Notebook 2 em 1Positivo Duo C4128B-3 Intel Celeron Dual Core Windows11 Home 11,6' - Cinza Escuro",
                Preco = 1439.10M,
                Estoque = 17,
                CategoriaId = 3,
            ...
            new Produto(){
                ...
                Descricao = "O novo Moto G04 foi projetado para impressionar com cores  vibrantes, material superior e detalhes lindos. Beleza em alto nível! Feito com materialde padrão elevado, é fino e confortável ao toque.",
                Preco = 699M,
                Estoque = 40,
                CategoriaId = 4,
